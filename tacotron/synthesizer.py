...
class Synthesizer:
	def load(self, checkpoint_path, hparams, gta=False, model_name='Tacotron', reference_mel = None):
		...
		with tf.variable_scope('model') as scope:
			...
			if gta:
				self.model.initialize(inputs, input_lengths, targets, gta=gta, reference_mel=reference_mel)
			else:		
	...
	def synthesize(self, text, index, out_dir, log_dir, mel_filename, reference_mel=None):
