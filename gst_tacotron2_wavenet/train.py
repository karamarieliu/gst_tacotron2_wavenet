...
def train(args, log_dir, hparams):
	...
	#Get training states
	(taco_state, GTA_state, wave_state), input_path = read_seq(state_file, args.restore)
...
def main():
	...
	parser.add_argument('--restore', type=bool, default=False, help='Set this to True to resume training')
	...
	parser.add_argument('--wavenet_train_steps', type=int, default=100000, help='total number of wavenet training steps')
